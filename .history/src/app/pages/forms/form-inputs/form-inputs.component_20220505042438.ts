...
export class FormInputsComponent implements OnInit {
  ...
  btnClick = function () {
    ...
    "imm": this.imm,"address": this.address,"gender": this.gender,"first_last_name": this.firstName,"cin": this.cin,
    "gender": this.gender,"type": this.type,"date": this.date,"affect": this.affect,"serie": this.serie,"constructor": this.constructor,
