...
export class FormInputsComponent implements OnInit {
  ...
  btnClick = function () {
    ...
    let dict = {"puissance": this.puissance,"energie": this.energie,"portes" :this.portes,"place": this.place,"poids": this.poids,
    "id": this.id,"firstName": this.firstName,"lastName": this.lastName,"otherName": this.otherName,"birthDate": this.birthDate,
    "imm": this.imm,"address": this.address,"gender": this.gender,"first_last_name": this.firstName,"cin": this.cin,"gender": this.gender,"type": this.type,"date": this.date,"affect": this.affect,"serie": this.serie,"constructor": this.constructor,
